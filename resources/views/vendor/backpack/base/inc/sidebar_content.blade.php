...
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('attendance') }}"><i class="nav-icon la la-church"></i> Attendances</a></li>
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('congregation') }}"><i class="nav-icon la la-users"></i> Congregations</a></li>
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('congregation-status') }}"><i class="nav-icon la la-cog"></i> Congregation statuses</a></li>
